...
public final class AFontRenderer extends AFont {
    ...
    public AFontRenderer(ResourceLocation resourceLocation, float size) {
    ...
    public float drawString(String text, double x, double y, int color, boolean shadow) {
        ...
        AFont.CharData[] currentData = this.charData;
